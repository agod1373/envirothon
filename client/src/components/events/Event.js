        ...
        <div className="main" style={{backgroundColor: themeBackground, width: '100vw'}}>
            ...
            {props.category==='General Knowledge' && 
                <div>
                    ...
                    <p style={{ cursor: 'pointer', textAlign: 'center', color: themeText }} onClick={() => setTranscript(!transcript)}>Show Transcript</p>
                    {transcript && 
                        <p style={{margin: '0px 20px', textAlign: 'center', color: themeText }}>
